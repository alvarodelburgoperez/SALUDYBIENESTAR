...
(function ($) {
    ...
    if (o) {
        ...
        $(document).ready(function () {
                ...
                var coordData = new google.maps.LatLng(parseFloat(40.646197), parseFloat(-73.9924068, 14));
                var markCoord1 = new google.maps.LatLng(parseFloat(40.643180), parseFloat(-73.9874068, 14));
                var arrDestinations = [markCoord1];
                ...
                function createMarkers(arrDestinations) {
                    var markers = [];
                ...
                markList = createMarkers(arrDestinations);
            }
        )
        ;
    }
